...
function UserTabs() {
  ...
  return (
    <Tab.Navigator screenOptions={{
      ...
      tabBarShowLabel: !isWeb,  // web shows label inside icon component
    }}>
...
// Web wrapper — centers phone-width content on wide screens
          ...
          {!user ? (
            ...
            <>
              <Stack.Screen name="Main"
                component={user.role?.toUpperCase() === 'PROVIDER' ? ProviderTabs : UserTabs} />
